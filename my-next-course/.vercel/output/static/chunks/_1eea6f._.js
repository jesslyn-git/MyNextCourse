...
function ProductPage() {
    ...
    const handleAddToWishlist = async (productId)=>{
        ...
        try {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$toastify$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error(`❌ ${error.message || "Error adding to wishlist"}`); // ✅ Show exact error message
        }
    };
